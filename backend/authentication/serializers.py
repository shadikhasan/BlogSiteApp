...
class UserRegistrationSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'phone_number', 'address', 'date_of_birth', 'bio', 'interested_in',
            'facebook_url', 'linkedin_url', 'youtube_url', 'github_url', 'profile_picture'
        ]
        extra_kwargs = {
    ...
    def create(self, validated_data):
        # Extract the password since it needs to be handled separately
        password = validated_data.pop('password')

        # Create the user object
        user = User(**validated_data)
        user.set_password(password)  # Set the password with proper hashing
        user.save()
...
class UserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'linkedin_url',
            'youtube_url',
            'github_url',  # Include social media fields
        ]
